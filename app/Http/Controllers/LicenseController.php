...
class LicenseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Clean domain
        $validated['domain'] = strtolower(preg_replace('#^https?://#', '', rtrim($validated['domain'], '/')));
    ...
    {
        $events = $license->events()->latest('created_at')->take(20)->get();
    ...
    public function renew(Request $request, License $license)
    {
        ...
        $license->logEvent('renewed', [
            ...
            'new_expires_at' => $validated['expires_at'],
        ]);
    ...
    public function update(Request $request, License $license)
    {
        ...
        return redirect()->route('licenses.show', $license)->with('success', 'License updated.');
    }
}
